//
//  SpritekitUIAccessExampleUITests.m
//  SpritekitUIAccessExampleUITests
//
...
- (void)testExample {
  ...
  XCTAssert(app.buttons[@"helloLabel"].exists);
  [app.buttons[@"node1"] tap];
  [app.buttons[@"node2"] tap];
  [app.buttons[@"nextBtn"] tap];
  XCTAssert(!app.buttons[@"helloLabel"].exists);
  [app.buttons[@"lastBtn"] tap];
  
  XCTAssert(app.buttons[@"helloLabel"].exists);
  [app.buttons[@"helloLabel"] tap];
}
